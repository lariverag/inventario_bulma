            ...
            <?php
                ...
                if ($categorias->rowCount()>0) {
                    ...
                    foreach($categorias as $row){
                        echo '
                            <a href="index.php?vista=product_category&category_id='.$row['categoria_id'].'" class="button is-link is-inverted is-fullwidth">'.$row['categoria_nombre'].'</a>
                        ';
                    }
                }else{
                    echo '
        ...
        <div class="column">
            <?php
                ...
                if ($categoria->rowCount()>0) {
                    ...
                    echo '
                        <h2 class="has-text-centered title">Seleccione una Categoria para empezar</h2>
                    ';
                }
